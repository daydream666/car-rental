...
public class AlipayController {
    ...
    public String payIndex(Integer id, Double price, String name, Integer score,
                           Double newPrice,Integer newScore,Integer index,Model model){
        //System.out.println(id+"=="+price+"=="+name);
        //System.out.println("优惠:"+newPrice+"=="+newScore);
        //第一次支付无积分优惠
        if (index==null){
    ...
    @RequestMapping("/pay")
    @ResponseBody
    public String pay(HttpServletRequest request, Integer id, HttpSession session) throws UnsupportedEncodingException, AlipayApiException {
        //获取订单id修改订单状态
        ...
        User user = userMapper.findByTelPwd(tel, "");
        Integer countOrderStatus = orderService.countOrderStatus(user.getId());
        scoreService.updateScoreByOrderStatus(user.getId(),
                countOrderStatus*10);
